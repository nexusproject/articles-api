...
CREATE TABLE `articles` (
  ...
  KEY `created` (`created`),
  KEY `updated` (`updated`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Articles'
/*!50100 PARTITION BY RANGE (year(`created`))
(PARTITION articles_current VALUES LESS THAN (2023) ENGINE = InnoDB,
 PARTITION articles_2023 VALUES LESS THAN (2024) ENGINE = InnoDB,
 PARTITION articles_2024 VALUES LESS THAN (2025) ENGINE = InnoDB,
 PARTITION articles_2025 VALUES LESS THAN (2026) ENGINE = InnoDB) */;
...
--
-- Dumping routines for database 'articles'
--
